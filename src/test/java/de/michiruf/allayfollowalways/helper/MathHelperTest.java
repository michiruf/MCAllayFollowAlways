...
public class MathHelperTest {
    ...
    public void angleBetweenTest() {
        Assertions.assertEquals(0, MathHelper.angleBetween(up, up, true));
        Assertions.assertEquals(0, MathHelper.angleBetweenDeg(up, up, true));

        Assertions.assertEquals(Math.PI / 2.0, MathHelper.angleBetween(up, left, true));
        Assertions.assertEquals(90, MathHelper.angleBetweenDeg(up, left, true));

        Assertions.assertEquals(Math.PI, MathHelper.angleBetween(up, down, true));
        Assertions.assertEquals(180, MathHelper.angleBetweenDeg(up, down, true));
        ...
        Assertions.assertEquals(92.10146543246499, MathHelper.angleBetweenDeg(
        ...
        Assertions.assertEquals(101.0958032831364, MathHelper.angleBetweenDeg(new Vec3(5, 1, -1), forward, false));
        Assertions.assertEquals(57.02103795287812, MathHelper.angleBetweenDeg(new Vec3(-5, -1, -1), new Vec3(-1, 0, 1), false));
    }
}
